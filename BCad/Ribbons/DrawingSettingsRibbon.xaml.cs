...
namespace BCad.Ribbons
{
    ...
    /// </summary>
    [ExportRibbonTab("drawing-settings")]
    public partial class DrawingSettingsRibbon : RibbonTab
    {
        private IWorkspace workspace = null;
        private DrawingSettingsViewModel viewModel = null;

        public DrawingSettingsRibbon()
        {
            InitializeComponent();
        }

        [ImportingConstructor]
        public DrawingSettingsRibbon(IWorkspace workspace)
            : this()
        {
