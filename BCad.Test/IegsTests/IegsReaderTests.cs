...
");
            ...
            Assert.Equal(IegsUnits.Centimeters, file.ModelUnits);
            ...
            Assert.Equal(IegsVersion.v5_0, file.IegsVersion);
            Assert.Equal(IegsDraftingStandard.BSI, file.DraftingStandard);
