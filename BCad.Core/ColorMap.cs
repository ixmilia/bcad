...
namespace BCad
{
    public class ColorMap
    {
        ...
        public static readonly ColorMap AutoCADDefault;
        public static readonly ColorMap Default;
        public static readonly ColorMap IgesDefault;

        static ColorMap()
        {
            AutoCADDefault = new ColorMap(acadDefaultColors);
            AllBlack = Create(Enumerable.Repeat(0, 256).Select(i => RealColor.FromInt(i)));
            IgesDefault = new ColorMap(igesDefaultColors);
            Default = AutoCADDefault;
        }

        private ColorMap(int[] colors)
        {
            if (colors == null)
            ...
            {
                this.colors[i] = RealColor.FromInt(colors[i]);
            }
        }
        ...
        private static int[] acadDefaultColors = new int[256]
        {
        ...
        private static int[] igesDefaultColors = new int[256]
        {
            0x000000, 0x000000, 0xFF0000, 0x00FF00, 0x0000FF, 0xFFFF00, 0xFF00FF, 0x00FFFF,
            0xFFFFFF, 0x808080, 0xFF0000, 0xFFAAAA, 0xBD0000, 0xBD7E7E, 0x810000, 0x815656,
            0x680000, 0x684545, 0x4F0000, 0x4F3535, 0xFF3F00, 0xFFBFAA, 0xBD2E00, 0xBD8D7E,
            0x811F00, 0x816056, 0x681900, 0x684E45, 0x4F1300, 0x4F3B35, 0xFF7F00, 0xFFD4AA,
            0xBD5E00, 0xBD9D7E, 0x814000, 0x816B56, 0x683400, 0x685645, 0x4F2700, 0x4F4235,
            0xFFBF00, 0xFFEAAA, 0xBD8D00, 0xBDAD7E, 0x816000, 0x817656, 0x684E00, 0x685F45,
