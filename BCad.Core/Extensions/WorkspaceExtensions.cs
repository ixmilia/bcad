...
namespace BCad
{
    public static class WorkspaceExtensions
    {
        ...
        public static void Add(this IWorkspace workspace, Layer layer, IObject obj)
        {
        ...
        public static void AddToCurrentLayer(this IWorkspace workspace, IObject obj)
        {
        ...
        public static void Replace(this IWorkspace workspace, Layer layer, IObject oldObject, IObject newObject)
        {
        ...
        public static void Remove(this IWorkspace workspace, Layer layer, IObject obj)
        {
