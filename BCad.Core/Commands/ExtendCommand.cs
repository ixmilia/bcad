...
namespace BCad.Commands
{
    ...
    public class ExtendCommand : ICommand
    {
        ...
        {
            var boundaries = await InputService.GetEntities("Select bounding edges");
            ...
            var directive = new UserDirective("Entity to extend");
            ...
            while (!selected.Cancel && selected.HasValue)
            {
                ...
                EditService.Extend(selected.Value, boundaryPrimitives, out removed, out added);
